...
export { LocalToDeviceMessage } from './serialization/local/local-to-device-message';
export { LocalToDeviceMessagePayload } from './serialization/local/local-to-device-message-payload';
